...
# Lang
$(B_DIR)/assets/files/L%E.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
	tools/assetmgr/mklang $< en

$(B_DIR)/assets/files/L%J.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
	tools/assetmgr/mklang $< jp

$(B_DIR)/assets/files/L%P.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
	tools/assetmgr/mklang $< gb

$(B_DIR)/assets/files/L%_str_f.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
	tools/assetmgr/mklang $< fr

$(B_DIR)/assets/files/L%_str_g.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
	tools/assetmgr/mklang $< de

$(B_DIR)/assets/files/L%_str_i.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
	tools/assetmgr/mklang $< it

$(B_DIR)/assets/files/L%_str_s.o: $(A_DIR)/lang/%.json $(C_DIR)/lang/%.json tools/assetmgr/mklang
...
# Cheats
$(G_DIR)/gen-cheats.h $(G_DIR)/cheats.c: $(C_DIR)/cheats.json tools/assetmgr/mkcheats
...
$(B_DIR)/generated/%.o: $(G_DIR)/%.c $(ASSETMGR_O_FILES) $(RECOMP_FILES)
	@mkdir -p $(dir $@)
	$(CC) -c $(CFLAGS) $(OPT_LVL) -o $@ $<
